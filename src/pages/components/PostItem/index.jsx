        ...
        <>
            <div className="card card-body d-inline-block m-3">
                ...
                <div className="d-flex justify-content-start input-group">
                    {state.isLiked ? (
                        <button className='btn btn-primary' disabled={true} onClick={() => {handleLike()}}>
                            <strong><i class="bi bi-hand-thumbs-up-fill"></i></strong>
                        </button>
                    ):(
                        <button className='btn btn-primary' disabled={false} onClick={() => {handleLike()}}>
                            <strong><i class="bi bi-hand-thumbs-up"></i></strong>
                        </button>
                    )}

                    {state.isDisliked ? (
                        <button className='btn btn-danger' disabled={true} onClick={() => {handleDislike()}}>
                            <strong><i class="bi bi-hand-thumbs-down-fill"></i></strong>
                        </button>
                    ):(
                        <button className='btn btn-danger' disabled={false} onClick={() => {handleDislike()}}>
